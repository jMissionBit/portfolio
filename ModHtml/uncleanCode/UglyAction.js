...
document.querySelector('#change-me-button').onclick = function () {
  document.querySelector('#change-me-title').innerHTML = 'Hello MissionBit'
}
...
document.querySelector('#style-me-button').onclick = function (event) {
  if (!x) {
    document.querySelector('#style-me-title').style.border = 'thin black solid'; event.target.innerHTML = 'again'; x = true;
  } else {
